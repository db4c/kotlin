...
fun DeclarationDescriptor.renderForConflicts(): String {
    return when (this) {
        ...
        is FunctionDescriptor -> KotlinBundle.message("fix.change.return.type.presentation.function", CALLABLE_RENDERER.render(this))
        is PropertyDescriptor -> KotlinBundle.message("fix.change.return.type.presentation.property", CALLABLE_RENDERER.render(this))
