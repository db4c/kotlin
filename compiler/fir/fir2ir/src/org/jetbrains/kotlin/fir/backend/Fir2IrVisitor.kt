...
//            }
    ...
    override fun visitComparisonOperator(comparisonOperator: FirComparisonOperator, data: Any?): IrElement {
        return comparisonOperator.convertWithOffsets { startOffset, endOffset ->
            generateComparisonCall(startOffset, endOffset, comparisonOperator)
        }
    }

    private fun generateComparisonCall(
        startOffset: Int, endOffset: Int,
        comparisonOperator: FirComparisonOperator
    ): IrExpression {
        val operation = comparisonOperator.operation
        ...
        fun fallbackToRealCall(): IrExpression {
            ...
            return primitiveOp2(
                ...
                booleanType,
                origin,
                visitFunctionCall(comparisonOperator.compareToCall, null),
                IrConstImpl.int(startOffset, endOffset, irBuiltIns.intType, 0)
            )
        }

        val comparisonInfo = comparisonOperator.inferPrimitiveNumericComparisonType() ?: return fallbackToRealCall()
        ...
        return primitiveOp2(
            ...
            comparisonOperator.left.toIrExpression(), comparisonOperator.right.toIrExpression()
        )
    }
