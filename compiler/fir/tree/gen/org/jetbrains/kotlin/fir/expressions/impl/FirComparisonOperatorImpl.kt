...
internal class FirComparisonOperatorImpl(
    override val source: FirSourceElement?,
    override val annotations: MutableList<FirAnnotationCall>,
    override val operation: FirOperation,
    override var compareToCall: FirFunctionCall,
) : FirComparisonOperator() {
    override var typeRef: FirTypeRef = IMPLICIT_BOOLEAN
    ...
    override fun <D> transformChildren(transformer: FirTransformer<D>, data: D): FirComparisonOperatorImpl {
